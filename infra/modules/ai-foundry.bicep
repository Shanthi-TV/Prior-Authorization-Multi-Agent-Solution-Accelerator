...
// for deploying Azure OpenAI models (e.g., gpt-5.3-chat) from the model catalog.
//
...
@description('Name for the model deployment (used in API calls, e.g. gpt-5.3-chat)')
