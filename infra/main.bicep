...
@minLength(1)
@description('Primary location for all resources. gpt-5.3-chat GlobalStandard is available in East US 2 and Sweden Central. DataZoneStandard is available in East US 2 only.')
@allowed([
  'swedencentral'
])
param location string

@description('Azure OpenAI deployment name to use across all agent containers (e.g., gpt-5.3-chat)')
